	...
	<div class="center800" >
		<form action="major_save" ajax="false" class="easyui-form" id="frm">
			<table class="detailBorder" border="2" width="400">
				...
				<tr>
					<th>所属学科大类：</th>
					<td><s:textfield name="majorInfo.bigClassID" data-options="validType:'length[1,30]'" size="20" cssClass="easyui-textbox" required="true"/></td>
				</tr>
				<tr>
					<th>专业名：</th>
				...
				<tr>
					<th>专业简介</th>
					<td><s:textfield name="majorInfo.descript" data-options="validType:'length[1,30]'" size="20" cssClass="easyui-textbox" required="true"/></td>
				</tr>
<%-- 				<tr>
					<th>所属学科大类名：</th>
