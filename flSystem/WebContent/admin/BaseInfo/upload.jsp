<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@taglib prefix="u" uri="/struts-tags"%>
<%
...
<body>
	<div class="center800">
		<div class="firstTitle">课程信息导入</div>
		<form id="fileUpload" action="../student_upload" method="post"
			...
			上传待导入的Excel文件：<br /> <input id="fb" name="upload"
				...
				href="${contextPath}/template/studentInfo.xls">下载课程信息模板</a>
		</form>
		<div class="firstTitle">专业信息导入</div>
		<form id="fileUpload" action="../student_upload" method="post"
			enctype="multipart/form-data">
			上传待导入的Excel文件：<br /> <input id="fb" name="upload"
				class="easyui-filebox" style="width: 300px"
				...
				href="javascript:void(0)" class="easyui-linkbutton"
				data-options="iconCls:'icon-redo'" onclick="uploadFile()">导入</a> <a
				href="${contextPath}/template/studentInfo.xls">下载专业信息模板</a>
		</form>
		<div class="firstTitle">学科大类信息导入</div>
		<form id="fileUpload" action="../student_upload" method="post"
			enctype="multipart/form-data">
			上传待导入的Excel文件：<br /> <input id="fb" name="upload"
				class="easyui-filebox" style="width: 300px"
				...
				href="javascript:void(0)" class="easyui-linkbutton"
				data-options="iconCls:'icon-redo'" onclick="uploadFile()">导入</a> <a
				href="${contextPath}/template/studentInfo.xls">下载学科大类信息模板</a>
		</form>
