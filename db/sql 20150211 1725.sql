...
INSERT INTO `control` (`annual`,`eachselect`,`channelselect`,`specSelect`,`startTime`) VALUES 
 ...
 ('2013',1,0,0,'2015-01-05 22:21:26');
...
INSERT INTO `fl_courses` (`courseID`,`courseName`,`credit`,`courseType`,`courseHours`) VALUES 
 ...
 ('04020','猪生产学','2.0','专业课',32),
 ('04021','羊生产学','2.0','专业课',32),
 ('04022','牛生产学','2.0','专业课',32),
 ('04023','禽生产学','2.0','专业课',32);
...
INSERT INTO `fl_notice` (`noticeID`,`title`,`content`,`pdate`,`skipNum`) VALUES 
 (1,'12312','12341234','2015-01-21 11:15:57',5),
 (2,'aaaaa','aaaa','2015-01-23 10:55:40',1),
 (3,'333333333','3333333333333333','2015-01-23 16:49:43',0),
 (4,'4444444444','444444444444','2015-01-23 16:49:57',0);
...
INSERT INTO `fl_student` (`loginName`,`grade`,`className`,`specialtyID`,`sixGrade`,`self_rec`,`checked`,`uName`,`sex`,`email`,`qq`,`webAddr`,`phone`,`tutorselected`,`bigclassId`,`channel`,`specselected`,`discipline`,`creditscore`,`tutorID`) VALUES 
 ('2012011001','2013','制药工程01',1,'434.0','dsadASDDASD',1,'李静楠j','女',NULL,NULL,NULL,NULL,0,1,'校内贯通培养',3,'有','82.0',NULL),
...
INSERT INTO `fl_tutor` (`loginName`,`specialtyID`,`res_interests`,`quota`,`introduce`,`photo`,`type`,`checked`,`uName`,`sex`,`email`,`qq`,`webAddr`,`phone`,`college`) VALUES 
 ('2008001001',1,'asdfasdf',3,'qwerqwer',NULL,'硕士生导师','false','名字','男','example1@example.com','111444777','http://blog.123.com','13312341234','风景园林艺术学院'),
 ('2008001002',1,'哈哈哈哈',0,'aaaa',NULL,'硕士生导师','false','测试1',NULL,'example2@example.com','800157036','http://blog.2.com','15314786412','旱区作物逆境生物学国家重点实验室'),
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='导师学生';
...
INSERT INTO `selectannual` (`annual`) VALUES 
 ('2013');
